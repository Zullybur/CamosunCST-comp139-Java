...
public interface EventSimulatorInterface {
    ...
    /**
     * Checks whether or not the door corresponding to the given floor is
     * open<br>
     *
     * Preconditions: numFloors is valid<br>
     * Postconditions: N/A<br>
    ...
    /**
     * Issue a time event. If the elevator is in motion, a tick event causes the
     * elevator to go to the next floor. If the elevator arrives, the doors open
     * and buttons state are changed immediately. If the elevator is stationary,
     * it checks for a floor and moves immediately if there is an outstanding
     * elevator request. Otherwise, this method does nothing.
     */
    public void tick();
}
